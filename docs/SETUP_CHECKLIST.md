...
- [x] **ダッシュボード公開** — <https://eda0825-spec.github.io/shojiki-rakuten-stats/>
- [x] **defects 用 private リポ 2 つ作成** — `shojiki-defects-j001` / `shojiki-defects-j002`
- [x] **Issue Template (中日バイリンガル)** + **26 ラベル** 配置済み
- [x] **不具合報告フォーム** — <https://eda0825-spec.github.io/shojiki-rakuten-stats/defects.html>
- [x] **不具合トラッカー画面** — <https://eda0825-spec.github.io/shojiki-rakuten-stats/defects-dashboard.html>
...
1. 工場メンバーから GitHub ユーザー名を集める
   - 中国語ガイドを送付: <https://eda0825-spec.github.io/shojiki-rakuten-stats/FACTORY_REPORT_GUIDE_ZH.md>
...
### A. 既存レビューが見える?
1. <https://eda0825-spec.github.io/shojiki-rakuten-stats/> を開く
2. 上のタブで J001 / J002 切替
3. 「不具合」フィルタを押す → 故障報告レビューだけ表示される
4. 「📋 Issue化」を押す → GitHub に prefill 状態の Issue 作成画面が開く
...
3. <https://eda0825-spec.github.io/shojiki-rakuten-stats/defects.html> から実際に1件報告
