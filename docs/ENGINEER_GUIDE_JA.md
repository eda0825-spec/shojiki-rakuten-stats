...
- 報告フォーム: <https://eda0825-spec.github.io/shojiki-rakuten-stats/defects.html>
- 集約ダッシュボード: <https://eda0825-spec.github.io/shojiki-rakuten-stats/defects-dashboard.html>
- 楽天/Amazon レビューダッシュボード: <https://eda0825-spec.github.io/shojiki-rakuten-stats/>
- 工場用ガイド: <./FACTORY_GUIDE_ZH.md>
